...
- Retain a bounded review-teaching follow-up and correct the optional CLINC research adapter's batched/single-request feature mismatch. Rebuilding with individual-request teaching features yields identical selection/runtime decisions on all 3,095 development requests, 86.6% supported coverage, 99.04% supported accepted accuracy, 1/100 unfamiliar acceptances and 2.69 ms p95. These are development results, not new qualification; the failed official test is retained.
