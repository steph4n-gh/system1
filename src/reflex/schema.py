"""Reflex Decision Schema Definitions.
...
from typing import Any, ClassVar, Dict, Mapping, Optional, Sequence, Tuple, Type, get_type_hints
    ...
    def __init__(
        ...
        *,
        ...
        self.descriptions: Dict[str, str] = {
            k: str(v).strip() for k, v in (descriptions or {}).items() if k in seen
        }
